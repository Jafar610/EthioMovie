      ...
      <div className="bg-[#010205] text-white w-full h-screen">
        <div>
          <div className="flex justify-between items-center py-4 px-20">
            ...
            <div className="flex justify-center items-center gap-2 border border-[#fab612] rounded-lg px-4 py-2">
              <LanguageIcon />
        ...
        <div className="flex justify-between items-center px-20">
          <div className="mt-50">
            ...
            <div className="flex justify-start items-center gap-10 py-6 text-[#fab612]">
              <div className="">
            ...
            <div className="">
              ...
              <form action="">
                <div className={hidden}>
                  ...
                  <div className="flex justify-start items-center gap-2 border border-[#a0a0a3] rounded-sm w-full py-2 px-2 my-1 text-[#a0a0a3]">
                    <PersonIcon />
                    <input
                      type="text"
                ...
                <div>
                  ...
                  <div className="flex justify-start items-center gap-2 border border-[#a0a0a3] rounded-sm w-full py-2 px-2  my-2 text-[#a0a0a3]">
                    <EmailIcon />
                    <input
                      type="email"
                ...
                <div className="flex justify-center items-center border border-[#fab612] rounded-lg py-2 px-4 bg-[#fab612]">
                  <button className="text-black font-semibold">Login</button>
                </div>

                <div className="flex justify-center items-center py-2 text-[#c9c8ca]">
