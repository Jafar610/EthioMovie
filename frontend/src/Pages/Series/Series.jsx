  ...
  return (
    <>
      <div className="px-20 bg-[#0b0d11] text-white w-full min-h-screen">
        <div className="py-3">
          <h1 className="text-4xl font-bold text-[#ecad2a]">Series</h1>
          <p className="text-lg py-4 text-[#b6b1b6]">
            Discover and watch the best TV series from Ethiopia and around the
            world.
          </p>
          <div className="flex justify-start items-center gap-10 pb-4">
            ...
            <div className="border border-[#232328] text-[#ecad2a] px-6 py-2 rounded-lg outline-none hover:scale-105 flex items-center gap-2">
              <TuneIcon />
              <button type="button" className="text-[#b6b1b6]">Filters</button>
            </div>
          </div>
              ...
              {currentMovies.map((movie, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 w-full px-2 py-2">
                    ...
                    <div className="py-2">
                        <p className="text-sm font-bold text-[#ecad2a]">S1.E4</p>
                    </div>
                  </div>
                </div>
              ))}
