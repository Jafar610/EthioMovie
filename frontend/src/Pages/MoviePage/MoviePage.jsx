     ...
     <div className='px-20'>
        <div>
            ...
            <div>
                ...
                <div className='grid grid-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 relative'>
                    {
                        movies.map((movie, index)=>(
                            <div key={index} className='rounded-xl overflow-hidden hover:scale-104 relative '>
                                ...
                                <div className='absolute insert-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent'>hello</div>
